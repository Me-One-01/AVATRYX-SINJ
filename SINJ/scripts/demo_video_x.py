...
from SINJ.utils.presets import SimpleTransform3DSMPLX
from SINJ.utils.render_pytorch3d import render_mesh
from SINJ.utils.vis import get_max_iou_box, get_one_box, vis_2d
...
parser = argparse.ArgumentParser(description='SINJ Demo')
