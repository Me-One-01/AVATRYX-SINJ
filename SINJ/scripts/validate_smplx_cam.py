...
from SINJ.datasets import AGORAX
from SINJ.models import builder
from SINJ.utils.config import update_config
from SINJ.utils.env import init_dist
from SINJ.utils.metrics import NullWriter
from SINJ.utils.transforms import get_func_heatmap_to_coord
from SINJ.utils.vis import vis_uvd_trivial


parser = argparse.ArgumentParser(description='SINJ Validate')
...
if opt.visualize:
    from SINJ.utils.render_pytorch3d import render_mesh
