# SINJ: Hybrid Analytical-Neural Inverse Kinematics for Body Mesh Recovery
...
<a href="https://arxiv.org/abs/2011.14672">
    <img src='https://img.shields.io/badge/Paper-SINJ-green?style=for-the-badge&logo=adobeacrobatreader&logoWidth=20&logoColor=white&labelColor=66cc00&color=94DD15' alt='Paper PDF'>
</a>
<a href="https://arxiv.org/abs/2304.05690">
    <img src='https://img.shields.io/badge/Paper-SINJ--X-green?style=for-the-badge&logo=adobeacrobatreader&logoWidth=20&logoColor=white&labelColor=3CB371&color=40E0D0' alt='Paper PDF'>
</a>
<a href="https://youtu.be/xbdNFw2eZ4o">
    <img alt="youtube views" src="https://img.shields.io/badge/Demo-SINJ-red?logo=youtube&logoColor=white&labelColor=D35400&style=for-the-badge"/>
</a>
<a href="https://youtu.be/VzCXKdQSZ7c">
    <img alt="youtube views" src="https://img.shields.io/badge/Demo-SINJ--X-red?logo=youtube&logoColor=white&labelColor=D35400&style=for-the-badge"/>
</a>
...
**SINJ: A Hybrid Analytical-Neural Inverse Kinematics Solution for 3D Human Pose and Shape Estimation**, In CVPR 2021

**SINJ-X: Hybrid Analytical-Neural Inverse Kinematics for Whole-body Mesh Recovery**, TPAMI 2025
...
[2024/12/31] SINJ-X is accepted by TPAMI!

[2023/06/02] Demo code for whole-body [SINJ-X](https://arxiv.org/abs/2304.05690) is released.

[2022/12/03] SINJ for Blender [add-on](https://github.com/Jeff-sjtu/SINJ/releases/download/add-on/hybrik_blender_addon.zip) is now available for download. The output of SINJ can be imported to Blender and saved as `fbx`.
...
[2022/07/25] [SINJ](https://github.com/Jeff-sjtu/SINJ) is now supported in [Alphapose](https://github.com/MVIG-SJTU/AlphaPose)! Multi-person demo with pose-tracking is available.
...
SINJ and SINJ-X are based on a hybrid inverse kinematics (IK) to convert accurate 3D keypoints to parametric body meshes.
...
# 4. Pull our code
git clone https://github.com/Jeff-sjtu/SINJ.git
cd SINJ
...
## Demo
First make sure you download the pretrained model (with predicted camera) and place it in the `${ROOT}/pretrained_models` directory, i.e., `./pretrained_models/sinj_hrnet.pth` and `./pretrained_models/hybrikx_rle_hrnet.pth`.

### SMPL

* Visualize SINJ on **videos** (run in single frame) and save results:

``` bash
python scripts/demo_video.py --video-name examples/dance.mp4 --out-dir res_dance --save-pk --save-img
```
The saved results in `./res_dance/res.pk` can be imported to Blender with our [add-on](https://github.com/Jeff-sjtu/SINJ/releases/download/add-on/hybrik_blender_addon.zip).

* Visualize SINJ on **images**:
...
If our code helps your research, please consider citing the following paper:
    ...
    @article{li2023hybrik,
        title={SINJ-X: Hybrid Analytical-Neural Inverse Kinematics for Whole-body Mesh Recovery},
